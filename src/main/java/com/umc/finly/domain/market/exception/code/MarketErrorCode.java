...
public enum MarketErrorCode implements BaseCode {
    ...
    MARKET_STOCK_NOT_FOUND(HttpStatus.NOT_FOUND, "MARKET404_2", "종목 데이터가 존재하지 않습니다."),
    // 5xx
    MARKET_INDEX_API_FAILED(HttpStatus.BAD_GATEWAY, "MARKET502_1", "시장 지표 조회 API 호출에 실패했습니다."),
    MARKET_INDEX_RESPONSE_INVALID(HttpStatus.BAD_GATEWAY, "MARKET502_2", "시장 지표 응답 형식이 올바르지 않습니다."),
