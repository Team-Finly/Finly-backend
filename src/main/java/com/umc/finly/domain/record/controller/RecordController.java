...
@Tag(name = "Record", description = "기록하기 API")
...
public class RecordController {
    ...
    @Operation(summary = "기록 생성", description = "새로운 기록을 생성하고 AI 피드백을 비동기로 요청")
    @PostMapping
    ...
    @Operation(summary = "해당 날짜 마음 조각 조회", description = "특정 날짜의 기록 목록과 프리즘 피드백을 조회")
    @GetMapping("/today")
    ...
    @Operation(summary = "기록 검색", description = "키워드 또는 감정 코드로 기록을 검색")
    @GetMapping("/search")
    ...
    @Operation(summary = "최근 검색 기록", description = "최근 검색한 키워드 목록을 조회 (최대 3개)")
    ...
    // 특정 검색 기록 삭제
    @Operation(summary = "검색 기록 삭제", description = "특정 검색 키워드를 삭제")
    ...
    @Operation(summary = "기록 상세 조회", description = "특정 기록의 상세 정보를 조회")
    @GetMapping("/{recordId}")
    ...
    // 기록 부분 수정 (PATCH)
    // null이 아닌 필드만 업데이트됨
    @Operation(summary = "기록 수정(제출)", description = "특정 기록의 정보를 부분 수정")
    ...
    @Operation(summary = "AI피드백 결과 조회", description = "특정 기록에 대한 AI 피드백을 조회")
    ...
    // 데일리 리포트 조회
    // 메모를 AI로 요약한 결과를 반환함
    @Operation(summary = "데일리 리포트 AI요약 조회", description = "특정 기록의 메모를 AI로 요약한 데일리 리포트를 조회")
    ...
    @Operation(summary = "AI피드백 재생성 요청", description = "특정 기록의 AI 피드백을 새로 생성")
