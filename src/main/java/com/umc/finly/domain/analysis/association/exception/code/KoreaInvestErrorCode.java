...
public enum KoreaInvestErrorCode implements BaseCode {
    ...
    STOCK_NOT_FOUND(HttpStatus.NOT_FOUND, "KI404_1", "존재하지 않는 종목입니다."),
    NO_DATA_FOUND(HttpStatus.NOT_FOUND, "KI404_2", "한국투자증권 API 응답에서 조회된 주가 데이터가 없습니다."),

    // 5xx
    API_BUSINESS_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "KI500", "한국투자증권 API 응답에서 에러가 발생했습니다."),
